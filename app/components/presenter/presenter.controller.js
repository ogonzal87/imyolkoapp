  ...
  $scope.pausePresentation = function() {
	...
	function displayYolkoInDashboard() {
		if($scope.dislikePercent >= 80) {
			...
			return $scope.avatarDashboard = {face: 'assets/icons/dash-notsogood.svg', message: 'Yolko is not so good', backgroundColor: 'lever-5-mood-color'};
		} else if ($scope.dislikePercent >= 40 && $scope.dislikePercent <= 59.999999999999) {
			return $scope.avatarDashboard = {face: 'assets/icons/dash-serious.svg', message: 'Yolko is ok', backgroundColor: ''};
		} else if ($scope.dislikePercent >= 20 && $scope.dislikePercent <= 39.999999999999) {
			return $scope.avatarDashboard = {face: 'assets/icons/dash-great.svg', message: 'Yolko is great', backgroundColor: 'lever-1-mood-color'};
